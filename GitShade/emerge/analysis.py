...
from GitShade.languages.abstractparser import AbstractResult, AbstractParser, LanguageType
# from emerge.metrics.abstractmetric import AbstractMetric, AbstractCodeMetric, AbstractGraphMetric, MetricResultFilter

from GitShade.emerge.files import FileManager
from GitShade.emerge.abstractresult import AbstractEntityResult, AbstractFileResult
from GitShade.emerge.graph import GraphRepresentation, GraphType, FileSystemNode, FileSystemNodeType
...
from GitShade.emerge.files import truncate_directory, LanguageExtension
...
class Analysis:
    ...
    def create_filesystem_graph(self) -> None:
        ...
        self.root_node = filesystem_root_node.absolute_name
